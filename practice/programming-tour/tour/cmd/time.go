...
import (
	"log"
	"programming-tour/tour/internal/timer"
	"strconv"
	"strings"
	"time"
...
var calculateTimeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err != nil {
			log.Fatal("timer.GetCalculateTime err: %v", err)
		}
...
func init() {
	...
	calculateTimeCmd.Flags().StringVarP(&duration, "duration", "d", "", `时间间隔，有效时间单位为"ns","us","ms","s","m","h"`)
}
